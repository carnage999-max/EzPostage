    ...
    return (
        <main className="min-h-screen bg-white font-sans antialiased text-gray-900 selection:bg-red-600 selection:text-white pt-24 pb-12">
            ...
            <div className="container mx-auto px-6 max-w-4xl py-12">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-8">Global Privacy Policy</h1>

                <div className="prose prose-lg prose-gray max-w-none space-y-8">
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                        <p className="text-sm font-semibold uppercase tracking-wider text-gray-500 mb-2">Gold Standard Edition</p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">3. Automated and AI‑Based Processing</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">5. Disclosure and Data Sharing</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">10. Security and Safeguards</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">12. Cross‑Border Compliance</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4">13. Data Protection Officer and Contact</h2>
                        <p>
                            We maintain a designated Data Protection Officer (“DPO”) to oversee compliance. Users may exercise their rights or submit complaints via email at <a href="mailto:privacy@ez-postage.com" className="text-blue-600 hover:underline">privacy@ez-postage.com</a> or by mail to our registered office:
                        </p>
                        <address className="not-italic mt-2 text-gray-600 block bg-gray-50 p-4 rounded-lg">
                            EzPost®<br />
                            PO Box 52,<br />
                            Detroit, ME 04929
                        </address>
                    ...
                    <p className="text-sm text-gray-500">
                        Annexes: This Policy may be supplemented by a Data Processing Addendum (DPA) for enterprise clients, a Cookie Policy, and jurisdiction‑specific addenda where required.
                    </p>
